    ...
    <>
      <div style={styles.container}>
        ...
        <div style={{ ...styles.block, ...styles.first }}>
          <h1 style={styles.h1}>Step 1: Enter Your Search Terms</h1>
          <p>
        ...
        <div style={{ ...styles.block, ...styles.fourth }}>
          ...
          <img src="/4-Step.jpg" alt="Step 4" style={styles.image} />
        </div>
        <div style={{ ...styles.block, ...styles.fifth }}>
          <h1 style={styles.h1}>Step 5: Download the PDF file</h1>
          <p>
